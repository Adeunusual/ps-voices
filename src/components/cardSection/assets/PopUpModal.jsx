...
const PopUpModal = ({ children, trigger, setTrigger, handleCardImgChange, imgSrc, renderCard, cardTxtInput, setCardTxtInput, needImg }) => {
        ...
        < div className='popUp' >
            <div className="popUpInner">
                ...
                <form action="" onSubmit={handleSubmit} className='popUp-form'>
                    <div className="block">
                        {needImg && <div id="upload-img-border">
                    ...
                    <div className='form-block-flex'>
                        <div className='form-block'>
                            ...
                            <input className='inputStyle' type="text" placeholder='e.g Abayomi'
                                name="name"
                                value={cardTxtInput.name}
                                onChange={handleChange}
                            />
                        </div>
                        <div className='form-block'>
                            <label className='labelStyle' htmlFor="twitter">Twitter handle</label>
                            <input className='inputStyle' type="text" placeholder='e.g @yomiblaze'
                                name="twitterHandle"
                                value={cardTxtInput.twitterHandle}
                                onChange={handleChange}
                            />
                        </div>
                    </div>
